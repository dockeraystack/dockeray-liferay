...
CATALINA_OPTS="$CATALINA_OPTS_BASIC $CATALINA_OPTS_ENVIRONMENT $CATALINA_OPTS_TOMCAT $CATALINA_OPTS_GC_LOGGING_FILE $CATALINA_OPTS_GC $CATALINA_OPTS_METASPACE $CATALINA_OPTS_OOM $CATALINA_OPTS_HEAP"